...
let isPopulationinfoCalculated = false;
...
app.get("/capitals", (req, res) => {
  ...
  // check for empty info in the output array
  countries = info
...
app.get("/populous", (req, res) => {
  ...
  if (!isPopulationinfoCalculated) {
    ...
    isPopulationinfoCalculated = true;
  }
...
app.get("/regions", (req, res) => {
  ...
  // disregard empty info from the output array
  let regionObject = {};
  info.forEach(country => {
